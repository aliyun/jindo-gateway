...
public class JfsRemoveDefaultAclRequest extends JfsAbstractHttpRequest {
    private static final String REQUEST_TYPE = "removeDefaultAcl";
    private static final String SRC_KEY = "src";

    public JfsRemoveDefaultAclRequest() {
        super();
