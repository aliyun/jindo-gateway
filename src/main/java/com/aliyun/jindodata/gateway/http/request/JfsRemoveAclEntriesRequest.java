...
public class JfsRemoveAclEntriesRequest extends JfsAbstractHttpRequest {
    private static final String REQUEST_TYPE = "removeAclEntries";
    private static final String SRC_KEY = "src";
    private static final String ACL_SPEC_KEY = "aclSpec";

    private List<AclEntry> aclSpec;

    public JfsRemoveAclEntriesRequest() {
        super();
